...
NEGATIVE_WORDS = {"sad","depressed","angry","mad","upset","hurt","stressed","anxious","anxiety","lonely","tired","broken","crying","frustrated","overwhelmed","worthless","miserable"}
POSITIVE_WORDS = {"happy","good","great","amazing","excited","proud","better","calm","strong","hopeful","motivated","winning"}
...
class Empathy(commands.Cog):
    ...
    async def checkin(self, ctx):
        embed = discord.Embed(title="Quick Check-In", description="How are you feeling right now?\nReply with one word or one short sentence.")
